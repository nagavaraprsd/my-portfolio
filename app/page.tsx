...
export default function Home() {
  return (
    <main className="w-full min-h-screen px-8 md:px-16 lg:px-24 py-20 text-slate-900">
      ...
      {/* HERO SECTION */}
      <section className="min-h-[80vh] flex flex-col-reverse lg:flex-row items-center justify-between gap-20">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <p className="text-slate-500 text-lg leading-relaxed max-w-2xl mb-10">
            ...
            focusing on clean code and solving real-world problems.
          </p>
